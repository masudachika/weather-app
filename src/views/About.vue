<template>
  <div class="about">
    <div class="weather">
      ...
      <a @click="$router.push({ name:'home' })" class="cp_btn">HOMEに戻る</a>
    </div>
  </div>
</template>
...
export default {
  ...
  async created() {
    const item = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${this.city}&units=metric&appid=a3a327f66220a4c2dc535cd524ba3ca4`
    );
